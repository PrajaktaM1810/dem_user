...
Color buttonColor = const Color(0xff01b5af);
Color theme = const Color(0xff01b5af);
...
Color loaderColor = const Color(0xff01b5af);
Color notUploadedColor = Colors.orange;
Color verifyPendingBck = const Color(0xffFEF2F2);
Color verifyPending = const Color(0xff01b5af);
...
Color borderLines = const Color(0xff01b5af);
